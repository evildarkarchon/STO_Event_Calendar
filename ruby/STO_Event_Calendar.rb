...
OptionParser.new do |parser|
  ...
  parser.on('-e', '--end [END]', Time, 'End date of the event.') { |e| stats.end = e }
...
stats.end = Time.strptime(gatherinfo('End Date (MM/DD/YYYY): '), "%m/%d/%Y") unless stats.end.respond_to?(:to_time)
